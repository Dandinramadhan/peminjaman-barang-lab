...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2024 at 07:10 AM
...
(9, 'Obeng Set Lengkap', 2, 1, 'Obengnya memiliki set lengkap'),
(10, 'Monitor LG', 3, 3, 'Barang Masih Bagus');
...
ALTER TABLE `pinjam`
  ...
  ADD CONSTRAINT `pinjam_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`);
